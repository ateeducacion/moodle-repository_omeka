...
$string['acceptedclasses'] = 'Clases de recurso aceptadas (opcional)';
$string['acceptedclasses_help'] = 'Restringe el listado a ítems de Omeka-S de estas clases de recurso. Deja vacío para mostrar todos. Puedes introducir términos con prefijo de vocabulario (p. ej. <code>lrmi:LearningResource, dctype:Image, bibo:Document</code>) o ids numéricos. Los valores múltiples se combinan con OR y se reenvían a <code>/api/items</code> como <code>resource_class_term[]</code> / <code>resource_class_id[]</code>, así que el filtrado ocurre en el servidor sin peticiones adicionales.';
$string['helpurl'] = 'URL de ayuda (opcional)';
$string['helpurl_help'] = 'URL que abre el botón de Ayuda de la barra del selector de archivos. Déjalo vacío para ocultar el botón. Útil para apuntar a la página de soporte de tu institución o a la documentación del plugin.';
$string['instancemessage'] = 'Mensaje de la barra (opcional)';
$string['instancemessage_help'] = 'Texto corto que se muestra en la zona de mensaje de la barra del selector de archivos. Déjalo vacío para ocultar el mensaje. Útil para explicar qué subconjunto de Omeka-S expone este repositorio (colección curada, clases aceptadas, etc.).';
$string['cannotdownload'] = 'No se pudo descargar el archivo desde Omeka-S.';
$string['linkedmedianotdownloadable'] = 'Este recurso de Omeka-S es un elemento externo enlazado (vídeo oEmbed, manifiesto IIIF o URL) y no se puede copiar a Moodle. En el selector de archivos, selecciona "Crear un enlace" para insertarlo como enlace externo.';
